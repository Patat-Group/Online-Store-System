...
namespace Services.Migrations
{
    ...
    [Migration("20210821161605_addDefaultValueForPictureUrl")]
    partial class addDefaultValueForPictureUrl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.ProductAndSubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("productAndSubCategories");
                });
            ...
            modelBuilder.Entity("Core.Entities.ProductAndSubCategory", b =>
                {
                    b.HasOne("Core.Entities.Product", "Product")
                        .WithMany("productAndSubCategories")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
